            ...
            <div className="bg-white rounded-3xl p-5 shadow-xs border border-slate-200">
                ...
                <div className="leading-tight flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-1.5 mt-1">
                    ...
                    <span className="text-xs font-bold text-slate-900 uppercase truncate">
                      {prepLabel(activePrepTypes, activeToothObj.restoration)}
                    </span>
                  </div>
              ...
              <div className="py-3 border-b border-slate-100 space-y-1.5">
                ...
                <div className="grid grid-cols-2 gap-1.5">
                  {activePrepTypes.slice(0, 8).map((p) => (
                    <button
                      key={p.id}
                      type="button"
              ...
              <div className="py-3 border-b border-slate-100 space-y-1.5">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-indigo-700 font-bold">Linked to #{activeToothObj.displayNum}</span>
                </div>
                <select
                  value={activeToothObj.material}
                  onChange={(e) => applyMaterial(e.target.value)}
                  className="w-full p-2 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:border-indigo-500 font-semibold text-slate-900"
                >
